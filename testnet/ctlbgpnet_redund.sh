...
function  printhelp()
{
  case $1 in
    "create")
      echo -e "usage: $0 $1" >&2
      echo -e "Create virtual bgp network." >&2
      ;;
    "delete")
      echo -e "usage: $0 $1" >&2
      echo -e "Delete virtual bgp network." >&2
      ;;
    *)
      ...
      echo -e "  setup               Setup dynamic routing." >&2
      echo -e "  clear               Clear dynamic routing." >&2
      echo -e "  create              Create virtual bgp network." >&2
      echo -e "  delete              Delete virtual bgp network." >&2
      ;;
  esac
}
...
redistribute bgp
router bgp 100
neighbor 172.16.100.2 remote-as 100
neighbor 10.1.1.200 remote-as 200
neighbor 10.1.2.200 remote-as 200
...
neighbor 10.2.1.200 remote-as 200
neighbor 10.2.2.200 remote-as 200
network 192.168.100.0 mask 255.255.255.0
EOF
...
configure terminal
router ospf
network 192.168.200.0/24 area 1
EOF
...
redistribute bgp
router bgp 200
neighbor 172.16.200.2 remote-as 200
neighbor 10.1.1.100 remote-as 100
neighbor 10.2.1.100 remote-as 100
...
neighbor 10.1.2.100 remote-as 100
neighbor 10.2.2.100 remote-as 100
network 192.168.200.0 mask 255.255.255.0
EOF
}
